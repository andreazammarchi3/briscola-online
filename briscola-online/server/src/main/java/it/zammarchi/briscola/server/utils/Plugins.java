package it.zammarchi.briscola.server.utils;
...
/**
 * Plugins of the Javalin server (including swagger)
 */
public class Plugins {
    public static OpenApiPlugin openApiPlugin(String apiVersion, String path) {
        ...
        info.setTitle("Briscola Online");
        info.setVersion(apiVersion);
        info.setDescription("An online version of Briscola card game");
